...
class FeedbackController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('publisher.feedback.index', [
            'feedback' => $feedback,
            'filters' => [
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route('publisher.feedback.show', $item)
    ...
    public function show(Request $request, AdvertiserFeedback $feedback)
    {
        ...
        return view('publisher.feedback.show', [
            'item' => $feedback,
            'types' => $this->types(),
            'statuses' => $this->statuses(),
        ]);
    ...
    public function update(Request $request, AdvertiserFeedback $feedback)
    {
        ...
        return redirect()
            ->route('publisher.feedback.show', $feedback)
    ...
    public function export(Request $request): StreamedResponse
    {
        ...
        $filename = 'publisher_feedback_' . now()->format('Y-m-d_His') . '.csv';
