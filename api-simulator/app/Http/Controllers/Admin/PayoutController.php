...
class PayoutController extends Controller
{
    public function index(Request $request)
    {
        ...
        $users = User::whereIn('role', ['publisher', 'advertiser'])
    ...
    {
        $payout = Payout::with(['user.userProfile'])->findOrFail($id);
    ...
    public function approve($id)
    {
        ...
        return response()->json(['success' => true, 'message' => 'Payout approved and marked as completed.']);
    }
        ...
        $query = Payout::query()
            ...
            ->where(function ($visibilityQuery) {
                $visibilityQuery
                    ...
                    ->orWhere(function ($advertiserQuery) {
                        $advertiserQuery
                            ->where('aq_users.role', 'advertiser')
                            ->where('aq_payouts.status', 'completed');
                    });
            });
