...
class CampaignReportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $allCampaigns    = Campaign::orderBy('name')->get(['id', 'name', 'advertiser_id']);
    ...
    public function export(Request $request)
    {
        ...
        $callback = function () use ($collection) {
            ...
            fputcsv($file, ['Period', 'Campaign Name', 'Advertiser Name', 'Advertiser Email', 'Impressions', 'Clicks', 'Conversions', 'Spend (€)', 'CTR (%)', 'ECPM (€)']);
            foreach ($collection as $row) {
                fputcsv($file, [
                    $row->month_formatted,
                    $row->campaign_name,
