...
class DirectCampaignController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('advertiser.direct-campaigns.index', [
    ...
    {
        return view('advertiser.direct-campaigns.create', $this->getCommonViewData());
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route('advertiser.direct-campaigns')
    ...
    public function show(int $id)
    {
        ...
        return view('advertiser.direct-campaigns.show', ['campaign' => $campaignData]);
    }

    public function edit(int $id)
    {
        $campaign = DirectCampaign::with(['targeting', 'zones.zone'])
            ->where('advertiser_id', auth()->id())
            ->find($id);
        ...
        return view('advertiser.direct-campaigns.edit', $viewData);
    }

    public function update(Request $request, int $id)
    {
        $campaign = DirectCampaign::where('advertiser_id', auth()->id())->find($id);
        ...
        return redirect()
            ->route('advertiser.direct-campaigns.show', $id)
    ...
    public function duplicate(int $id)
    {
        ...
        $newCampaign->advertiser_id = auth()->id();
        $newCampaign->save();
