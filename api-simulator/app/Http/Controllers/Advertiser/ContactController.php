...
class ContactController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('advertiser.contacts.index', [
            'contacts' => $contacts,
            'filters' => [
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('advertiser.contacts')->with('success', 'Contact created.');
    }
    ...
    public function update(Request $request, AdvertiserContact $contact)
    {
        ...
        return redirect()->route('advertiser.contacts', $request->only(['search', 'type', 'status']))->with('success', 'Contact updated.');
    }
    ...
    public function destroy(Request $request, AdvertiserContact $contact)
    {
        ...
        return redirect()->route('advertiser.contacts')->with('success', 'Contact deleted.');
    }
    ...
    public function export(Request $request): StreamedResponse
    {
        ...
        $filename = 'advertiser_contacts_' . now()->format('Y-m-d_His') . '.csv';
    ...
    private function platformContacts(Request $request): array
    {
        ...
        return [
            ...
            [
                ...
                'phone' => null,
                'description' => 'Technical issues, campaign review questions, and platform access.',
            ],
            [
                'label' => 'Billing Team',
                ...
                'email' => config('mail.from.address'),
                'phone' => null,
                'description' => 'Invoices, deposits, subscription plans, and payment questions.',
            ],
        ];
    }
