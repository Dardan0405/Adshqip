...
<div class="space-y-6">
    ...
    <div class="grid gap-6 xl:grid-cols-3">
        <div class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm xl:col-span-1">
            ...
            <form method="POST" action="{{ route('advertiser.help-center.tickets.store') }}" class="mt-4 space-y-4">
                @csrf
                <div>
        ...
        <div class="space-y-6 xl:col-span-2">
            <div class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
                <div class="flex flex-col gap-3 lg:flex-row lg:items-end">
                    <form method="GET" action="{{ route('advertiser.help-center') }}" class="grid flex-1 gap-3 sm:grid-cols-3">
    ...
    <div class="rounded-lg border border-gray-200 bg-white shadow-sm">
        <div class="border-b border-gray-100 px-5 py-4">
            <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                ...
                <form method="GET" action="{{ route('advertiser.help-center') }}">
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($tickets as $ticket)
                        <tr class="hover:bg-gray-50">
                            <td class="px-5 py-4">
                                <a href="{{ route('advertiser.help-center.tickets.show', $ticket) }}" class="font-semibold text-brand-700 hover:text-brand-800">#{{ $ticket->id }} {{ $ticket->subject }}</a>
                            </td>
