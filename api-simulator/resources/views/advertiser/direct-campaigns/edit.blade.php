...
<form method="POST" action="{{ route('advertiser.direct-campaigns.update', $campaign['id']) }}" enctype="multipart/form-data" id="directCampaignForm">
    @csrf
    @method('PUT')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
            <div class="flex items-center gap-2 text-sm text-gray-400 mb-1">
                ...
                <a href="{{ route('advertiser.direct-campaigns.show', $campaign['id']) }}" class="hover:text-gray-600 transition-colors">#{{ $campaign['id'] }}</a>
                <svg class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none"><path d="M9 5l7 7-7 7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('advertiser.direct-campaigns.show', $campaign['id']) }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-200 bg-white text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors">Cancel</a>
    ...
    <div class="flex items-center justify-end gap-3 mb-10">
        <a href="{{ route('advertiser.direct-campaigns.show', $campaign['id']) }}" class="px-5 py-2.5 rounded-lg border border-gray-200 bg-white text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors">Cancel</a>
