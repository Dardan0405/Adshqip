...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <div class="flex items-center gap-2">
            ...
            <a href="{{ route('advertiser.direct-campaigns.create') }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-brand-600 text-sm font-semibold text-white hover:bg-brand-700 shadow-sm transition-colors">
    ...
    <div class="bg-white rounded-xl border border-gray-200 mb-6">
        <div class="px-5 py-4 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div class="flex items-center gap-1 overflow-x-auto">
                ...
                @endphp
                @foreach($tabs as $tab)
                    <a href="{{ route('advertiser.direct-campaigns', ['status' => $tab['key'], 'search' => $search]) }}"
            ...
            <form method="GET" action="{{ route('advertiser.direct-campaigns') }}" class="relative">
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors group">
                            ...
                            <td class="px-5 py-3.5">
                                <div class="flex items-center justify-center gap-1">
                                    ...
                                    <a href="{{ route('advertiser.direct-campaigns.show', $campaign['id']) }}" title="View Details" class="p-1.5 rounded-lg hover:bg-gray-100 text-gray-400 hover:text-gray-600 transition-colors">
                                    ...
                                    <a href="{{ route('advertiser.direct-campaigns.edit', $campaign['id']) }}" title="Edit" class="p-1.5 rounded-lg hover:bg-gray-100 text-gray-400 hover:text-gray-600 transition-colors">
                                    ...
                                    @if($campaign['status'] === 'pending_review')
                                        <form method="POST" action="{{ route('advertiser.direct-campaigns.updateStatus', $campaign['id']) }}" class="inline">
                                            @csrf @method('PATCH')
                                    ...
                                    <div class="relative" x-data="{ open: false }">
                                        ...
                                        <div x-show="open" @click.away="open = false"
                                            ...
                                            <a href="{{ route('advertiser.direct-campaigns.show', $campaign['id']) }}" class="flex items-center gap-2 px-3 py-2 text-xs text-gray-600 hover:bg-gray-50">
                                            ...
                                            <form method="POST" action="{{ route('advertiser.direct-campaigns.duplicate', $campaign['id']) }}" class="block">
                                                @csrf
                ...
                @if($pagination['total_pages'] > 1)
                    <div class="flex items-center gap-1">
                        @if($pagination['current_page'] > 1)
                            <a href="{{ route('advertiser.direct-campaigns', ['status' => $statusFilter, 'search' => $search, 'page' => $pagination['current_page'] - 1]) }}"
                        ...
                        @for($p = 1; $p <= $pagination['total_pages']; $p++)
                            ...
                            @else
                                <a href="{{ route('advertiser.direct-campaigns', ['status' => $statusFilter, 'search' => $search, 'page' => $p]) }}"
    ...
    <div id="exportModal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black/40">
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 p-6">
            ...
            <div class="grid grid-cols-2 gap-3 mb-5">
                <a href="{{ route('advertiser.direct-campaigns.export', ['format' => 'excel', 'status' => $statusFilter]) }}" class="flex flex-col items-center gap-2 p-4 rounded-xl border border-gray-200 hover:border-emerald-300 hover:bg-emerald-50 transition-colors group cursor-pointer">
                ...
                <a href="{{ route('advertiser.direct-campaigns.export', ['format' => 'csv', 'status' => $statusFilter]) }}" class="flex flex-col items-center gap-2 p-4 rounded-xl border border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-colors group cursor-pointer">
    ...
    function confirmDelete(id, name) {
        ...
        document.getElementById('deleteForm').action = '/advertisers/direct-campaigns/' + id;
