...
<div class="space-y-6">
    <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Submit and track your advertiser identity and business verification.</p>
        </div>
    </div>
    ...
    <div class="grid gap-6 xl:grid-cols-[minmax(0,2fr),380px]">
        <div class="rounded-2xl border border-gray-200 bg-white shadow-sm">
            ...
            <form method="POST" action="{{ $isEdit ? route('advertiser.kyc-verification.update', $verification) : route('advertiser.kyc-verification.store') }}" enctype="multipart/form-data" class="p-6">
                @csrf
                @if($isEdit)
                    @method('PUT')
                @endif
