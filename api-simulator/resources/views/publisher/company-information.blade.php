...
@section('content')
    ...
    <div class="space-y-6">
        <div class="relative overflow-hidden rounded-[28px] border border-slate-200 bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-900 px-6 py-7 text-white shadow-sm">
            ...
            <div class="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                <div class="max-w-2xl">
                    ...
                    <h1 class="mt-4 text-3xl font-semibold tracking-tight">Manage the business details connected to your publisher account.</h1>
                    <p class="mt-3 max-w-xl text-sm leading-6 text-slate-200/85">
                        Keep your company name and address information current so the account stays ready for invoices, billing records, and publisher operations.
                    </p>
                </div>
        ...
        <form method="POST" action="{{ route('publisher.company-information.update') }}" class="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1.4fr)_360px]">
            @csrf
            @method('PUT')
            ...
            <section class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                <div class="mb-6 flex items-center justify-between gap-4">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-slate-500">These fields describe the business information attached to this publisher account.</p>
                    </div>
