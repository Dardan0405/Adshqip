...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Manage publisher payouts and approved advertiser payment records.</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
        @php
            $statCards = [
                ...
                ['label' => 'This Month', 'value' => '€' . number_format($thisMonthAmount, 2), 'color' => 'text-purple-700', 'bg' => 'bg-purple-50', 'border' => 'border-purple-200', 'icon' => '<path d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>'],
            ];
        @endphp
    ...
    <div class="bg-white rounded-xl border border-gray-200 mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4">
            <form method="GET" action="{{ route('admin.payouts') }}" class="flex items-center gap-2 flex-1 flex-wrap">
                ...
                <a href="{{ route('admin.payouts') }}" class="px-4 py-2 rounded-lg border border-gray-200 text-sm font-medium text-gray-600 hover:bg-gray-50">Reset</a>
            </form>
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-2 w-44 bg-white rounded-xl border border-gray-200 shadow-lg py-1 z-50" style="display:none;">
                    ...
                    <a href="{{ route('admin.payouts.export', request()->all()) }}" class="flex items-center gap-2 w-full px-4 py-2 text-sm text-gray-600 hover:bg-gray-50">CSV</a>
        ...
        <div class="overflow-x-auto">
            <table id="payoutsTable" class="w-full text-sm">
                <thead>
                    ...
                    @forelse($payouts as $payout)
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors" id="row-{{ $payout->id }}">
                            ...
                            <td class="px-4 py-3">
                                ...
                                <div class="text-xs text-gray-400">{{ optional($payout->processed_at)->format('H:i') ?: 'Pending' }}</div>
                            </td>
                            <td class="px-4 py-3">
                            ...
                            <td class="px-4 py-3 text-center">
                                <div class="inline-flex items-center gap-1.5">
                                    ...
                                    @if($payout->status === 'pending')
                                        <button onclick="approvePayout({{ $payout->id }})"
                        ...
                        <tr>
                            <td colspan="8" class="px-4 py-12 text-center">
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <p class="text-sm text-gray-500">No payouts found.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
        ...
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-lg z-10">
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                    <h3 class="text-lg font-bold text-gray-900">Payout Details</h3>
...
<script>
    function viewDetails(id) {
                ...
                <div class="space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-sm font-semibold text-emerald-700">€${data.amount}</div>
                        </div>
                        <div>
                            <div class="text-[10px] font-semibold text-gray-400 uppercase tracking-wider mb-1">Payment Method</div>
                        ...
                        <div>
                            <div class="text-[10px] font-semibold text-gray-400 uppercase tracking-wider mb-1">Processed At</div>
                            <div class="text-sm text-gray-700">${data.processed_at || 'Pending'}</div>
                        </div>
                        <div>
        ...
        .catch(() => {
            content.innerHTML = '<p class="text-sm text-red-500 text-center py-8">Failed to load payout details.</p>';
        });
    }
    ...
    function approvePayout(id) {
        ...
        fetch(`/admin/payouts/${id}/approve`, {
            method: 'PATCH',
            headers: {
    ...
    function rejectPayout(id) {
        ...
        .catch(() => alert('Failed to reject payout.'));
    }
