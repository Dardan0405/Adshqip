...
@section('title', 'Advertiser Reports')
...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Advertiser Reports</h1>
            <p class="text-sm text-gray-500 mt-1">Monthly performance breakdown by advertiser — impressions, clicks, conversions, spend, CTR & ECPM.</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4">
            <form method="GET" action="{{ route('admin.reports.advertiser') }}" class="flex items-center gap-2 flex-1 flex-wrap">
                {{-- Search --}}
                ...
                @if(request()->hasAny(['search', 'advertiser_id', 'start_month', 'end_month']))
                    <a href="{{ route('admin.reports.advertiser') }}"
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <div x-show="open" @click.away="open = false" x-transition
                    ...
                    <a href="{{ route('admin.reports.advertiser.export', request()->all()) }}"
        ...
        <div class="overflow-x-auto">
            <table id="advertiserReportsTable" class="w-full text-sm">
                <thead>
                        ...
                        <tr>
                            <td colspan="8" class="px-4 py-12 text-center">
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <p class="text-sm text-gray-500">No advertiser report data found.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
...
<script>
    function copyTable() {
        const table = document.getElementById('advertiserReportsTable');
