...
@section('content')
    ...
    <div class="bg-white rounded-xl border border-gray-200 mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4">
            <form method="GET" action="{{ route('admin.reports.campaign') }}" class="flex items-center gap-2 flex-1 flex-wrap">
                {{-- Search --}}
                ...
                @if(request()->hasAny(['search', 'campaign_id', 'advertiser_id', 'start_month', 'end_month']))
                    <a href="{{ route('admin.reports.campaign') }}"
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <div x-show="open" @click.away="open = false" x-transition
                    ...
                    <a href="{{ route('admin.reports.campaign.export', request()->all()) }}"
