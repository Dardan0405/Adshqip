...
@section('content')
    ...
    <div class="space-y-6">
        ...
        <form method="POST" action="{{ route('admin.account-settings.update') }}" enctype="multipart/form-data" class="grid grid-cols-1 gap-6 xl:grid-cols-3">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <a href="{{ route('admin.billing-information') }}" class="inline-flex w-full items-center justify-center rounded-2xl border border-slate-200 px-5 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-50">
                    Billing Information
                </a>
            </div>
        </form>
