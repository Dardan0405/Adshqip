...
@section('content')
    ...
    <div class="space-y-6">
        ...
        <form method="POST" action="{{ route('admin.company-information.update') }}" class="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1.4fr)_360px]">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                <section class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <div class="mt-5 space-y-3">
                        <a href="{{ route('admin.personal-information') }}" class="inline-flex w-full items-center justify-center rounded-2xl border border-slate-200 px-5 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-50">
