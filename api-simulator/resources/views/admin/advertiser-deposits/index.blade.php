...
@section('title', 'Advertiser Deposits')
...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Advertiser Deposits</h1>
            <p class="text-sm text-gray-500 mt-1">Track advertiser deposit transactions with filterable payment and status details.</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4">
            <form method="GET" action="{{ route('admin.advertiser-deposits') }}" class="flex items-center gap-2 flex-1 flex-wrap">
                ...
                <a href="{{ route('admin.advertiser-deposits') }}" class="px-4 py-2 rounded-lg border border-gray-200 text-sm font-medium text-gray-600 hover:bg-gray-50">Reset</a>
            </form>
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-2 w-44 bg-white rounded-xl border border-gray-200 shadow-lg py-1 z-50" style="display:none;">
                    ...
                    <a href="{{ route('admin.advertiser-deposits.export', request()->all()) }}" class="flex items-center gap-2 w-full px-4 py-2 text-sm text-gray-600 hover:bg-gray-50">CSV</a>
        ...
        <div class="overflow-x-auto">
            <table id="advertiserDepositsTable" class="w-full text-sm">
                <thead>
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($deposits as $deposit)
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="px-4 py-3 text-right font-semibold text-emerald-700">€{{ number_format((float) $deposit->amount, 2) }}</td>
...
<script>
    function copyTable() {
        const table = document.getElementById('advertiserDepositsTable');
