...
<form method="POST" action="{{ route('admin.direct-campaigns.store') }}" enctype="multipart/form-data" id="directCampaignForm">
    @csrf
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('admin.direct-campaigns') }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-200 bg-white text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors">Cancel</a>
    ...
    <div class="flex items-center justify-end gap-3 mb-10">
        <a href="{{ route('admin.direct-campaigns') }}" class="px-5 py-2.5 rounded-lg border border-gray-200 bg-white text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors">Cancel</a>
