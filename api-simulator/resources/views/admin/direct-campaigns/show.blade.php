...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('admin.direct-campaigns') }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-200 bg-white text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors">
            ...
            <a href="{{ route('admin.direct-campaigns.edit', $campaign['id']) }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-brand-600 text-sm font-semibold text-white hover:bg-brand-700 shadow-sm transition-colors">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl border border-gray-200">
                ...
                <div class="p-4 space-y-2">
                    <a href="{{ route('admin.direct-campaigns.edit', $campaign['id']) }}" class="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-gray-50 transition-colors text-sm text-gray-700">
                    ...
                    <form method="POST" action="{{ route('admin.direct-campaigns.duplicate', $campaign['id']) }}">
                        @csrf
                    ...
                    @if($campaign['status'] === 'active')
                        <form method="POST" action="{{ route('admin.direct-campaigns.updateStatus', $campaign['id']) }}">
                            @csrf @method('PATCH')
                    ...
                    <form method="POST" action="{{ route('admin.direct-campaigns.destroy', $campaign['id']) }}" onsubmit="return confirm('Are you sure you want to delete this campaign?')">
                        @csrf @method('DELETE')
